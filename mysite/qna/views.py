...
@login_required #import from  from django.contrib.auth.decorators import login_required
def index(request):
...
class QuestionDetail(LoginRequiredMixin,DetailView): #import  django.contrib.auth.mixins import LoginRequiredMixin and django.views.generic import ListView,DetailView
